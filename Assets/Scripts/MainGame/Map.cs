...
namespace MainGame
{
    public class Map : MonoBehaviour
    {
        ...
        {
            const int add = 20; // a possible tree each 50 m2
        ...
        {
            const int add = 50; // a possible tree each 50 m2
        ...
        {
            const int add = 4; // a possible tree each 4 m2
